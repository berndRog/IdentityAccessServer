...
//    //    string start, 
//    //    string end
//    // ) => await GetAllAccountsAsync<TransactionDto>($"accounts/{accountId}/transactions/filter?start={start}&end={end}");
//    //    
...
//       string start, 
//       string end
//    ) => await GetAllAccountsAsync<TransactionListItemDto>($"accounts/{accountId}/transactions/listitems?start={start}&end={end}");
//                                     
// }